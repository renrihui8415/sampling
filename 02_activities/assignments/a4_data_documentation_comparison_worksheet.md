...
| Sources of error | Sampling Error; Non-sampling Error (including Coverage Error, Non-response, response errors and processing errors) | Sample Representation: The sample may not fully represent Canada's demographic makeup. Survey Mode: Online surveys can exclude those without internet access.
Temporal Limitations: Data reflects opinions at specific times and may miss later changes. Question Wording: The phrasing of questions can influence responses. Limited Variables: The dataset might not include all relevant variables. | Observation error, environmental variability                                                |
| Limitations, known biases | Non-response bias         | Selection Bias: More politically engaged individuals might be overrepresented. Social Desirability Bias: Respondents might give socially acceptable answers. Mode Effects: Online surveys can introduce biases different from other methods.
Recall Bias: Participants may inaccurately recall past behaviors or attitudes. Response Bias: Some respondents might consistently provide biased answers. | When building the Model of Maximum Detection Distances: 1. Model Bias: Using the lowest hearing thresholds for moths may bias the model in favor of moths; 2. Threshold Bias: Using the low hearing threshold of Noctua pronuba may lead to overestimation of detection distances for moths; 3. Duration Correction Bias: Adjusting hearing thresholds for shorter call durations may further bias the model towards moths.                                                     |
